...
(defn modify-channel
  ...
  [channel-id params]
  (http/modify-channel channel-id params))

(defn delete-channel
  "Deletes a channel. channel-id is a string snowflake. Returns the
  deleted channel map."
  [channel-id]
  (http/delete-channel channel-id))
...
(defn create-channel
  ...
  [guild-id params]
  (http/create-channel guild-id params))
...
(defn send-channel-message
  ...
  [channel-id params]
  (http/send-channel-message channel-id params))
...
(defn get-channel-message
  ...
  (http/get-channel-message channel-id message-id))
...
(defn get-channel-messages
  ...
  (http/get-channel-messages channel-id query-params))
...
(defn bulk-delete-messages
  ...
  (http/bulk-delete-messages channel-id message-ids))
...
(defn create-reaction
  ...
  (http/create-reaction channel-id message-id emoji))
...
(defn delete-own-reaction
  ...
  [channel-id message-id emoji]
  (http/delete-own-reaction channel-id message-id emoji))
...
(defn delete-user-reaction
  ...
  (http/delete-user-reaction channel-id message-id emoji user-id))
...
(defn get-reactions
  ...
  (http/get-reactions channel-id message-id emoji query-params))
...
(defn modify-guild
  ...
  [guild-id params]
  (http/modify-guild guild-id params))
...
(defn get-guild-member
  ...
  [guild-id user-id]
  (http/get-guild-member guild-id user-id))
...
(defn list-guild-members
  ...
  (http/list-guild-members guild-id query-params))
...
(defn add-guild-member-role
  ...
  (http/add-guild-member-role guild-id user-id role-id))
...
(defn remove-guild-member-role
  ...
  [guild-id user-id role-id]
  (http/remove-guild-member-role guild-id user-id role-id))
...
(defn create-guild-role
  ...
  [guild-id params]
  (http/create-guild-role guild-id params))
...
(defn register-global-command
  ...
  [app-id command-data]
  (interactions/register-global-command app-id command-data))
...
(defn register-guild-command
  ...
  (interactions/register-guild-command app-id guild-id command-data))
...
(defn list-global-commands
  ...
  [app-id]
  (interactions/list-global-commands app-id))
...
(defn list-guild-commands
  ...
  [app-id guild-id]
  (interactions/list-guild-commands app-id guild-id))

(defn delete-global-command
  "Deletes a global application command. app-id and command-id are string
  snowflakes. Returns :ok on success."
  [app-id command-id]
  (interactions/delete-global-command app-id command-id))
...
(defn delete-guild-command
  ...
  (interactions/delete-guild-command app-id guild-id command-id))
...
(defn bulk-overwrite-global-commands
  ...
  [app-id commands]
  (interactions/bulk-overwrite-global-commands app-id commands))
...
(defn bulk-overwrite-guild-commands
  ...
  (interactions/bulk-overwrite-guild-commands app-id guild-id commands))
...
(defn respond-to-interaction
  ...
  (interactions/respond-to-interaction interaction-id interaction-token callback-type data))
...
(defn create-followup-message
  ...
  (interactions/create-followup-message app-id interaction-token message-data))
...
(defn edit-original-response
  ...
  Returns the updated message map."
  [app-id interaction-token message-data]
  (interactions/edit-original-response app-id interaction-token message-data))
...
(defn delete-original-response
  ...
  (interactions/delete-original-response app-id interaction-token))
